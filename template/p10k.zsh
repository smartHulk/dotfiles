# Generated by Powerlevel10k configuration wizard on 2026-09-21 at 13:33 CEST.
...
() {
  ...
  [[ $ZSH_VERSION == (5.<1->*|<6->.*) ]] || return
   ...
   typeset -g POWERLEVEL9K_CUSTOM_YODA="echo -n '\uf1d0'"
   typeset -g POWERLEVEL9K_CUSTOM_YODA_FOREGROUND="green"
   typeset -g POWERLEVEL9K_CUSTOM_YODA_BACKGROUND="black"
   typeset -g POWERLEVEL9K_SHOW_CHANGESET="true"  

  # The list of segments shown on the left. Fill it with the most important segments.
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    custom_yoda                 # os identifier
