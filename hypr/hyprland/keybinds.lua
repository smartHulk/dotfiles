...
hl.bind(mainMod .. " + L", hl.dsp.exec_cmd("pidof hyprlock || hyprlock"), { description = "Session: Lock" })
--##! Applications
...
hl.bind(mainMod .. " + CTRL + SHIFT + left",    hl.dsp.workspace.move({ monitor = "left" }))
hl.bind(mainMod .. " + CTRL + SHIFT + right",    hl.dsp.workspace.move({ monitor = "right" }))
